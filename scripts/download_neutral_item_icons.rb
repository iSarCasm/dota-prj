...
CATEGORY_URL = "#{BASE_URL}/Category:Dota_2_neutral_item_icons"
OUTPUT_DIR = 'neutral_item_icons'
...
def extract_file_links(html_content)
  ...
  # Pattern: /commons/File:Name_itemicon_dota2_gameasset.png
...
def main
  puts "Starting Dota 2 neutral item icon downloader..."
  ...
  file_names = get_files_via_api('Category:Dota_2_neutral_item_icons')
  ...
  puts "Found #{file_names.length} neutral item icon files"
  puts
