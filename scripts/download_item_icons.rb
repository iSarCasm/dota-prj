...
CATEGORY_URL = "#{BASE_URL}/Category:Dota_2_item_icons"
OUTPUT_DIR = 'item_icons'
...
def main
  puts "Starting Dota 2 item icon downloader..."
  ...
  file_names = get_files_via_api('Category:Dota_2_item_icons')
  ...
  puts "Found #{file_names.length} item icon files"
  puts
