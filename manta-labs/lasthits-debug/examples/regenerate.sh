...
MERGED_REPLAYS="${MERGED_REPLAYS:-$(bash ../proofs/pathcorner-lane-spawn/list-replays.sh ../../dota-replays)}"
...
bash ../proofs/pathcorner-lane-spawn/visualize-dots.sh
echo "Done. Review examples/*.{txt,json,svg} and examples/pathcorner-lane-dots/"
